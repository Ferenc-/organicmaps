...
{
  private static final Logger LOGGER = new Logger(Logger.Scope.NETWORK, HttpUploader.class);
  ...
  public Result upload()
  {
    ...
    try
    {
      ...
      LOGGER.d("Start bookmarks upload on url: '" + Utils.makeUrlSafe(getPayload().getUrl()) + "'");
      ...
      LOGGER.d("Upload bookmarks status code: " + status);
      reader = new BufferedReader(new InputStreamReader(connection.getInputStream()));
      message = readResponse(reader);
      long duration = (System.currentTimeMillis() - startTime) / 1000;
      LOGGER.d("Upload bookmarks response: '" + message + "', " +
  ...
  private String readErrorResponse(@NonNull HttpURLConnection connection)
  {
    ...
    {
      LOGGER.e("Failed to read a error stream.");
    }
    finally
    {
      Utils.closeSafely(reader);
