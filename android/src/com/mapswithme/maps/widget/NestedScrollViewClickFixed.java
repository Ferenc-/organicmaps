...
public class NestedScrollViewClickFixed extends FrameLayout implements NestedScrollingParent2,
    ...
    private static final Logger LOGGER = new Logger(Logger.Scope.MAIN, NestedScrollViewClickFixed.class);
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_MOVE: {
                ...
                if (pointerIndex == -1) {
                    LOGGER.e("Invalid pointerId=" + activePointerId + " in onInterceptTouchEvent");
                    break;
                }
        ...
        switch (actionMasked) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (activePointerIndex == -1) {
                    LOGGER.e("Invalid pointerId=" + mActivePointerId + " in onTouchEvent");
                    break;
                }
