...
public class RichPlacePageController implements PlacePageController, LocationListener,
                                                ...
                                                Closable
{
  private static final Logger LOGGER = new Logger(Logger.Scope.MAIN, RichPlacePageController.class);
  ...
  private void setPeekHeight()
  {
    ...
    {
      LOGGER.d("Peek animation in progress, ignore.");
      return;
    }
    ...
    {
      LOGGER.d("Sheet state inappropriate, ignore.");
      return;
    }
      ...
      oldTop, int oldRight, int oldBottom)
  {
    ...
    {
      LOGGER.d("Layout change ignored, peek height not calculated yet");
      return;
    }
