...
{
  private static final Logger LOGGER = new Logger(Logger.Scope.MAIN, PlacePageView.class);
  ...
  private void onBookmarkBtnClicked()
  {
    if (mMapObject == null)
    {
      LOGGER.e("Bookmark cannot be managed, mMapObject is null!");
      return;
    }
  ...
  private void onShareBtnClicked()
  {
    if (mMapObject == null)
    {
      LOGGER.e("A map object cannot be shared, it's null!");
      return;
    }
  ...
  private void onBackBtnClicked()
  {
    if (mMapObject == null)
    {
      LOGGER.e("A mwm request cannot be handled, mMapObject is null!");
      getActivity().finish();
      return;
    }
  ...
  void refreshViews()
  {
    if (mMapObject == null)
    {
      LOGGER.e("A place page views cannot be refreshed, mMapObject is null");
      return;
    }
...
//    showTaxiOffer(mapObject);
  ...
  public void refreshLocation(Location l)
  {
    if (mMapObject == null)
    {
      ...
      //LOGGER.e("A location cannot be refreshed, mMapObject is null!");
      return;
    }
  ...
  public void onClick(View v)
  {
    switch (v.getId())
    {
      ...
      case R.id.ll__place_editor:
        if (mMapObject == null)
        {
          LOGGER.e("Cannot start editor, map object is null!");
          break;
        }
      ...
      case R.id.ll__place_latlon:
        ...
        if (mMapObject == null)
        {
          LOGGER.e("A LatLon cannot be refreshed, mMapObject is null");
          break;
        }
      ...
      case R.id.ll__place_wiki:
        ...
        if (mMapObject == null)
        {
          LOGGER.e("Cannot follow url, mMapObject is null!");
          break;
        }
  ...
  public boolean onLongClick(View v)
  {
    ...
    switch (v.getId())
    {
      ...
      case R.id.ll__place_latlon:
        if (mMapObject == null)
        {
          LOGGER.e("A long click tap on LatLon cannot be handled, mMapObject is null!");
          break;
        }
  ...
  private class EditBookmarkClickListener implements OnClickListener
  {
    ...
    public void onClick(View v)
    {
      if (mMapObject == null)
      {
        LOGGER.e("A bookmark cannot be edited, mMapObject is null!");
        return;
      }
