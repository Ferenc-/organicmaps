...
public enum BookmarksSharingHelper
{
  ...
  private static final Logger LOGGER = new Logger(Logger.Scope.MAIN, BookmarksSharingHelper.class);
                                       ...
                                       @NonNull BookmarkSharingResult result)
  {
    ...
    switch (result.getCode())
    {
      ...
      case BookmarkSharingResult.FILE_ERROR:
        ...
        LOGGER.e("Failed to share bookmark category '" + catName + "', error code: " + result.getCode());
        break;
      default:
