...
{
  private static final Logger LOGGER = new Logger(Logger.Scope.LOCATION, AndroidNativeProvider.class);
  ...
  public void start(long interval)
  {
    ...
    {
      LOGGER.d("Request Android native provider '" + provider
      ...
      LOGGER.d("provider = '" + provider + "' last location = " + location);
      if (location != null)
        mListener.onLocationChanged(location);
