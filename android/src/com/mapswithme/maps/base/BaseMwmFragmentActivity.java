...
{
  private static final Logger LOGGER = new Logger(Logger.Scope.MAIN, BaseMwmFragmentActivity.class);
  ...
  private boolean onBackPressedInternal(@NonNull Fragment currentFragment)
  {
    ...
    {
      LOGGER.i("Fragment '" + currentFragment + "' doesn't handle back press by itself.");
      return false;
    }
  }
