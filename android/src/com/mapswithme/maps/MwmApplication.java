...
public class MwmApplication extends Application implements AppBackgroundTracker.OnTransitionListener
{
  ...
  @NonNull
  private static final Logger LOGGER = new Logger(Logger.Scope.MAIN, MwmApplication.class);
  ...
  public void onCreate()
  {
    ...
    LOGGER.d("Settings path = " + settingsPath);
