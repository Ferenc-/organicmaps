...
public enum CrashlyticsUtils implements Initializable<Context>
{
  ...
  private final static Logger LOGGER = new Logger(Logger.Scope.THIRD_PARTY, CrashlyticsUtils.class);
  ...
  private void setCollectionEnabled(boolean isEnabled)
  {
    if (isEnabled)
    {
      LOGGER.d("Crashlytics enabled");
    }
    else
    {
      LOGGER.d("Crashlytics disabled");
    }
